...
# ERJ 3/11/13 used to test including this in simple_mods.rb model
#   -worked different than out of box (just _0 rather than _0_0 _0_1 out of box
module YUL:OM::XML::TerminologyBasedSolrizer
