...
module Hydra
  module Datastream
    class CollProperties < ActiveFedora::NokogiriDatastream       
      ...
      def extract_title
        terms = {}
        self.find_by_terms(:title).each do |term|
          ::Solrizer::Extractor.insert_solr_field_value(terms, "title_s",term.text)
        end
        return terms
      end
